...
// Модифікувати модальну форму для вибору лікаря / We modify the modal form for choosing a doctor
...
// Ф-ція присвоєння класу пообраному лікурю / The function of assigning a form class according to the selected doctor
    selectForm(event) {
